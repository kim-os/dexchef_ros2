...
static const _TaskTarget_type_support_symbol_names_t _TaskTarget_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_kitchen_interfaces, msg, TaskTarget)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, grasp_kitchen_interfaces, msg, TaskTarget)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, grasp_kitchen_interfaces, msg, TaskTarget)() {
  return &::grasp_kitchen_interfaces::msg::rosidl_typesupport_c::TaskTarget_message_type_support_handle;
}
