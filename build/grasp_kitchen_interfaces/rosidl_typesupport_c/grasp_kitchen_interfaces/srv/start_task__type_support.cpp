...
static const _StartTask_Request_type_support_symbol_names_t _StartTask_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_kitchen_interfaces, srv, StartTask_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, grasp_kitchen_interfaces, srv, StartTask_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, grasp_kitchen_interfaces, srv, StartTask_Request)() {
  return &::grasp_kitchen_interfaces::srv::rosidl_typesupport_c::StartTask_Request_message_type_support_handle;
}
...
static const _StartTask_Response_type_support_symbol_names_t _StartTask_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_kitchen_interfaces, srv, StartTask_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, grasp_kitchen_interfaces, srv, StartTask_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, grasp_kitchen_interfaces, srv, StartTask_Response)() {
  return &::grasp_kitchen_interfaces::srv::rosidl_typesupport_c::StartTask_Response_message_type_support_handle;
}
...
static const _StartTask_type_support_symbol_names_t _StartTask_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_kitchen_interfaces, srv, StartTask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, grasp_kitchen_interfaces, srv, StartTask)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, grasp_kitchen_interfaces, srv, StartTask)() {
  return &::grasp_kitchen_interfaces::srv::rosidl_typesupport_c::StartTask_service_type_support_handle;
}
