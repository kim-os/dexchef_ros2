...
#ifndef GRASP_KITCHEN_INTERFACES__SRV__DETAIL__START_TASK__FUNCTIONS_H_
#define GRASP_KITCHEN_INTERFACES__SRV__DETAIL__START_TASK__FUNCTIONS_H_
...
/// Initialize srv/StartTask message.
/**
...
/// Finalize srv/StartTask message.
/**
...
/// Create srv/StartTask message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * grasp_kitchen_interfaces__srv__StartTask_Request__init().
...
/// Destroy srv/StartTask message.
/**
 * It calls
 * grasp_kitchen_interfaces__srv__StartTask_Request__fini()
...
/// Check for srv/StartTask message equality.
/**
...
/// Initialize array of srv/StartTask messages.
/**
...
/// Finalize array of srv/StartTask messages.
/**
 * It calls
 * grasp_kitchen_interfaces__srv__StartTask_Request__fini()
...
/// Create array of srv/StartTask messages.
/**
 * It allocates the memory for the array and calls
 * grasp_kitchen_interfaces__srv__StartTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StartTask messages.
/**
 * It calls
 * grasp_kitchen_interfaces__srv__StartTask_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StartTask message array equality.
/**
...
/// Copy an array of srv/StartTask messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * grasp_kitchen_interfaces__srv__StartTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_grasp_kitchen_interfaces
...
/**
 * It calls
 * grasp_kitchen_interfaces__srv__StartTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_grasp_kitchen_interfaces
...
/**
 * It allocates the memory for the array and calls
 * grasp_kitchen_interfaces__srv__StartTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_grasp_kitchen_interfaces
...
/**
 * It calls
 * grasp_kitchen_interfaces__srv__StartTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GRASP_KITCHEN_INTERFACES__SRV__DETAIL__START_TASK__FUNCTIONS_H_
