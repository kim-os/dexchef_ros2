...
#include "grasp_kitchen_interfaces/action/detail/follow_cartesian_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Goal & ros_message)
{
  // Member: waypoints
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Goal;
    is_plain =
      (
      offsetof(DataType, max_acceleration) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Goal *>(
    untyped_ros_message);
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_Goal)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_grasp_kitchen_interfaces
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_Result)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_grasp_kitchen_interfaces
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Feedback & ros_message)
{
  // Member: current_index
  cdr >> ros_message.current_index;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_Feedback)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_Feedback__handle;
}
...
// functions for grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_grasp_kitchen_interfaces
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_FollowCartesianTrajectory_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_SendGoal_Request)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_grasp_kitchen_interfaces
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_SendGoal_Response)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_SendGoal_Response__handle;
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_SendGoal)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_grasp_kitchen_interfaces
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_GetResult_Request)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_grasp_kitchen_interfaces
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_FollowCartesianTrajectory_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_GetResult_Response)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_GetResult_Response__handle;
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_GetResult)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_GetResult__handle;
}
...
// functions for grasp_kitchen_interfaces::action::FollowCartesianTrajectory_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_grasp_kitchen_interfaces
cdr_serialize(
  const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  grasp_kitchen_interfaces::action::FollowCartesianTrajectory_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_FollowCartesianTrajectory_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces::action::FollowCartesianTrajectory_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const grasp_kitchen_interfaces::action::FollowCartesianTrajectory_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<grasp_kitchen_interfaces::action::FollowCartesianTrajectory_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_kitchen_interfaces, action, FollowCartesianTrajectory_FeedbackMessage)() {
  return &grasp_kitchen_interfaces::action::typesupport_fastrtps_cpp::_FollowCartesianTrajectory_FeedbackMessage__handle;
}
