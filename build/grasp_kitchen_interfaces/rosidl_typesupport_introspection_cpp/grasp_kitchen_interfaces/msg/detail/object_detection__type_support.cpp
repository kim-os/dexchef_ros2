...
{
  new (message_memory) grasp_kitchen_interfaces::msg::ObjectDetection(_init);
}

void ObjectDetection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<grasp_kitchen_interfaces::msg::ObjectDetection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectDetection_message_member_array[5] = {
  {
    ...
    offsetof(grasp_kitchen_interfaces::msg::ObjectDetection, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(grasp_kitchen_interfaces::msg::ObjectDetection, class_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(grasp_kitchen_interfaces::msg::ObjectDetection, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(grasp_kitchen_interfaces::msg::ObjectDetection, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(grasp_kitchen_interfaces::msg::ObjectDetection, size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectDetection_message_members = {
  ...
  5,  // number of fields
  sizeof(grasp_kitchen_interfaces::msg::ObjectDetection),
...
{
  return &::grasp_kitchen_interfaces::msg::rosidl_typesupport_introspection_cpp::ObjectDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, grasp_kitchen_interfaces, msg, ObjectDetection)() {
  return &::grasp_kitchen_interfaces::msg::rosidl_typesupport_introspection_cpp::ObjectDetection_message_type_support_handle;
}
