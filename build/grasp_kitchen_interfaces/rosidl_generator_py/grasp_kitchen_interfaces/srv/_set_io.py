...
class SetIO_Request(metaclass=Metaclass_SetIO_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.io_name = kwargs.get('io_name', str())
    ...
    @builtins.property
    def io_name(self):
        """Message field 'io_name'."""
        return self._io_name

    @io_name.setter
    def io_name(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'io_name' field must be of type 'str'"
        self._io_name = value
...
class Metaclass_SetIO(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'grasp_kitchen_interfaces.srv.SetIO')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from grasp_kitchen_interfaces.srv import _set_io
...
class SetIO(metaclass=Metaclass_SetIO):
    from grasp_kitchen_interfaces.srv._set_io import SetIO_Request as Request
    from grasp_kitchen_interfaces.srv._set_io import SetIO_Response as Response
