...
bool grasp_kitchen_interfaces__msg__task_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("grasp_kitchen_interfaces.msg._task_target.TaskTarget", full_classname_dest, 52) == 0);
  }
  grasp_kitchen_interfaces__msg__TaskTarget * ros_message = _ros_message;
  {  // task_id
  ...
  {  // place_pose
    ...
    if (!geometry_msgs__msg__pose__convert_from_py(field, &ros_message->place_pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of TaskTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("grasp_kitchen_interfaces.msg._task_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskTarget");
  ...
  {  // place_pose
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose__convert_to_py(&ros_message->place_pose);
    if (!field) {
      return NULL;
    }
    {
