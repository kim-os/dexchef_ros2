...
bool grasp_kitchen_interfaces__msg__object_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("grasp_kitchen_interfaces.msg._object_detection.ObjectDetection", full_classname_dest, 62) == 0);
  }
  grasp_kitchen_interfaces__msg__ObjectDetection * ros_message = _ros_message;
  {  // id
...
PyObject * grasp_kitchen_interfaces__msg__object_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("grasp_kitchen_interfaces.msg._object_detection");
