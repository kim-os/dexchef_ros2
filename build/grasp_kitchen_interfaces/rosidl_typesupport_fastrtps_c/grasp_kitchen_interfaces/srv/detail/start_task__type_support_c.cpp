...
#include "grasp_kitchen_interfaces/srv/detail/start_task__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // scene_id, target_class, task_type
#include "rosidl_runtime_c/string_functions.h"  // scene_id, target_class, task_type

// forward declare type support functions


using _StartTask_Request__ros_msg_type = grasp_kitchen_interfaces__srv__StartTask_Request;
...
size_t get_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Request(
  const void * untyped_ros_message,
...
static uint32_t _StartTask_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_grasp_kitchen_interfaces
size_t max_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = grasp_kitchen_interfaces__srv__StartTask_Request;
    is_plain =
      (
...
static size_t _StartTask_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_kitchen_interfaces, srv, StartTask_Request)() {
...
using _StartTask_Response__ros_msg_type = grasp_kitchen_interfaces__srv__StartTask_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_grasp_kitchen_interfaces
size_t get_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StartTask_Response__ros_msg_type * ros_message = static_cast<const _StartTask_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_grasp_kitchen_interfaces
size_t max_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = grasp_kitchen_interfaces__srv__StartTask_Response;
    is_plain =
      (
...
static size_t _StartTask_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_grasp_kitchen_interfaces__srv__StartTask_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_kitchen_interfaces, srv, StartTask_Response)() {
...
// already included above
// #include "grasp_kitchen_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "grasp_kitchen_interfaces/srv/start_task.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_kitchen_interfaces, srv, StartTask)() {
